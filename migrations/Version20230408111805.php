...
final class Version20230408111805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE parameters (id INT AUTO_INCREMENT NOT NULL, monday_f_o TIME NOT NULL, monday_f_c TIME NOT NULL, monday_s_o TIME NOT NULL, monday_s_c TIME NOT NULL, tuesday_f_o TIME NOT NULL, tuesday_f_c TIME NOT NULL, tuesday_s_o TIME NOT NULL, tuesday_s_c TIME NOT NULL, wednesday_f_o TIME NOT NULL, wednesday_f_c TIME NOT NULL, wednesday_s_o TIME NOT NULL, wednesday_s_c TIME NOT NULL, thursday_f_o TIME NOT NULL, thursday_f_c TIME NOT NULL, thursday_s_o TIME NOT NULL, thursday_s_c TIME NOT NULL, friday_f_o TIME NOT NULL, friday_f_c TIME NOT NULL, friday_s_o TIME NOT NULL, friday_s_c TIME NOT NULL, saturday_f_o TIME NOT NULL, saturday_f_c TIME NOT NULL, saturday_s_o TIME NOT NULL, saturday_s_c TIME NOT NULL, sunday_f_o TIME NOT NULL, sunday_f_c TIME NOT NULL, sunday_s_o TIME NOT NULL, sunday_s_c TIME NOT NULL, number_total_seat INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
